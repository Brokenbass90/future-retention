...
function normalizeDesignSection(section, index = 0) {
  ...
  return {
    ...
    style: {
      ...
      surfaceKind: pickFirstString(rawStyle.surfaceKind, rawStyle.surface_kind),
      surfaceNodeId: pickFirstString(rawStyle.surfaceNodeId, rawStyle.surface_node_id),
      surfaceCoverage: normalizePositiveNumber(rawStyle.surfaceCoverage ?? rawStyle.surface_coverage),
      isDark: Boolean(rawStyle.isDark || rawStyle.is_dark),
